 ...
 *
 */
public interface FlowPropertyValueProvider<FA extends FlowPropertyProvider> {
    /**
     *
     ...
     */
    <T> T get(FA flowPropertyProvider, FlowPropertyDefinition flowPropertyDefinition);
}
