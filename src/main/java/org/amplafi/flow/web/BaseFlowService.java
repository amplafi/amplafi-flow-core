...
public class BaseFlowService implements FlowService {
	...
	protected FlowState doActualService(FlowRequest request, String flowType, String flowId,
			String renderResult, PrintWriter writer,
			Map<String, String> initial, String complete,
			String advanceToActivity, boolean currentFlow) throws IOException,
			FlowNotFoundException, FlowRedirectException {
		return completeFlowState(flowType, flowId, renderResult, initial, complete, currentFlow, writer, advanceToActivity);
	}

	protected FlowState getFlowState(String flowType, String flowId, String renderResult,
			Map<String, String> initial, Writer writer, boolean currentFlow) throws IOException {
	...
	protected void renderValidationException(FlowValidationException e, String flowType,
	...
	public void renderError(Writer writer, String message, String renderResult,
			FlowState flowState, Exception exception) throws IOException {
	...
	private boolean completeFlow(FlowState flowState, String renderResult, String complete, Writer writer, String advanceToActivity)
			throws IOException {
		if (complete == null) {
		...
		if (ADVANCE_TO_END.equalsIgnoreCase(complete)) {
			...
			while (success == null
					...
					&& !flowState.isFinishable()
					&& !flowState.getCurrentActivityByName().equals(
							advanceToActivity)) {
