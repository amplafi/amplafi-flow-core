...
public abstract class AbstractFlowTranslator<T> implements FlowTranslator<T> {
    ...
    /**
     * @see org.amplafi.flow.translator.FlowTranslator#deserialize(FlowPropertyDefinition, DataClassDefinition, java.lang.Object)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     */
    @Override
    public final JSONWriter serialize(FlowPropertyDefinition flowPropertyDefinition, DataClassDefinition dataClassDefinition, JSONWriter jsonWriter, T object) {
        if ( jsonWriter == null ) {
    ...
    /**
     * @return a JsonWriter (generated by {@link FlowTranslatorResolver} usually )
     */
    ...
    protected JSONWriter doSerialize(FlowPropertyDefinition flowPropertyDefinition, DataClassDefinition dataClassDefinition, JSONWriter jsonWriter, T object) {
     ...
     * @return TODO
     */
    public JSONWriter toJson(JSONWriter jsonWriter, T object) {
